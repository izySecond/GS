# Vorbemerkungen
- Dieses Repo enthält die STM32Cube FM. Das Originalrepo von  STM liegt in GitHub unter STMicroelectronics/STM32CubeF4. Auf GitHub ist das Repo FranzKorf/STM32CubeF4 ein Fork des Originalrepos. 
- Unter Verwendung zweier Repos wurden die Daten auf den gitlab Server der HAW geschoben. So können auch Pull Request an das Originalrepo von STM auf GitHub geschickt werden.
- Weiterhin können so Änderungen in der STM32CubF4 FW übernommen werden.
- Weiter Informationen s. **README_HAW.md**
